...
Verify screen page Create - CheckAsset
	...
	#ชื่ออุปกรณ์ภาษาไทย *
	Wait Until Contains Get Text Split String Join    ${ASSETMANAGEMENTINFORMATION_ADDEDIT_LBL_ASSETNAMETH_LOCATOR}    ${ASSETMANAGEMENTINFORMATION_ADDEDIT_LBL_ASSETNAMETH_EN} 
