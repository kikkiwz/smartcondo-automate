...
*** Test Cases ***
################### Change owner ###################
M13_0_1_31_002_RoomOwner_Success_ChangeOwner_Status2_JuristicPerson_VerifyScreen [Verify screen page "Change owner"]
...
Verify screen page "Change owner" [Juristic person] 
...
Verify screen page "Change owner" [Juristic person][Attach other documents]       
...
Verify screen page "Change owner" [Juristic person][Transfer detail]       
    ############## Transfer detail ############## 
    # Transfer detail
...
Verify screen page "Change owner" [Juristic person][Asset list]        
    ############## Asset list ############## 
    #Asset list
...
Verify screen : Verify screen tab "Popup Profile"[Juristic person]
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMOWNER_CHANGEOWNER_M13_0_1_31_002_SUCCESS_SCREENSHOT}
