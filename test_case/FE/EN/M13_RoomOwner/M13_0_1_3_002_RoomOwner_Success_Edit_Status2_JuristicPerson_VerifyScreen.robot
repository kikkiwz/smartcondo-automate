...
*** Test Cases ***
################### [Edit] EditRoomOwner ###################
M13_0_1_3_002_RoomOwner_Success_Edit_Status2_JuristicPerson_VerifyScreen [Verify screen page "Edit room owner"]
    ...
    #Juristic person :
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_JURISTICPERSON_LOCATOR}    ${ROOMOWNER_ADD_LBL_JURISTICPERSON_EN}

Verify screen page "Edit room owner" [Juristic person] 
    ...
    #Owner
    Wait Element Not Visible    ${ROOMOWNER_ADD_LBL_TYPE_OWNER_1_LOCATOR}
    #Guest
    Wait Element Not Visible    ${ROOMOWNER_ADD_LBL_TYPE_GUESTPERSON_1_LOCATOR}
    ...
    # Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_UPLOADAPICTUREOFALEGALENTITY_LOCATOR}    ${ROOMOWNER_ADD_LBL_UPLOADAPICTUREOFALEGALENTITY_EN} 
    Wait Element Visible    ${ROOMOWNER_ADD_IMG_UPLOADAPICTUREOFALEGALENTITY_LOCATOR}
    
    #Company name *
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_COMPANYNAME_LOCATOR}    ${ROOMOWNER_ADD_LBL_COMPANYNAME_EN} 
    Wait Should Contain Get Element Attribute    ${ROOMOWNER_ADD_LBL_COMPANYNAME_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}  
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_COMPANYNAME_LOCATOR} 
    #Short name
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SHORTNAME_LOCATOR}    ${ROOMOWNER_ADD_LBL_SHORTNAME_EN} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_SHORTNAME_LOCATOR}
    #Juristic id
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_JURISTICID_LOCATOR}    ${ROOMOWNER_ADD_LBL_JURISTICID_EN} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_JURISTICID_LOCATOR}
    #Tax identification number
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_EN} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_TAXIDENTIFICATIONNUMBER_JURISTIC_LOCATOR}
    # Wait Until Contains Element Should Be Visible    ${ROOMOWNER_ADD_INPUT_TAXIDENTIFICATIONNUMBER_JURISTIC_LOCATOR}
    ...
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_HOVER_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_HOVER_EN} 
    ...
    #Fax
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_FAX_LOCATOR}    ${ROOMOWNER_ADD_LBL_FAX_EN} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_FAX_LOCATOR}
    #E-mail
    ...
    #Read identification card
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_BTN_READIDENTIFICATIONCARD_2_LOCATOR}    ${ROOMOWNER_ADD_BTN_READIDENTIFICATIONCARD_EN} 
    #Note: The picture will be shown only when reading from the ID card only.
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_NOTE_IMAGE_THAINATIONS_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_NOTE_IMAGE_THAINATIONS_EN} 
    ...
    #Tax identification number
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_EN} 
    ...
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_2_HOVER_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_HOVER_EN} 
    
    #Education
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_EDUCATION_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_EDUCATION_EN} 
    #Occupation
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_OCCUPATION_2_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_OCCUPATION_EN} 
    #[กรอกอาชีพอื่นๆ]
    Wait Until Contains Element Should Be Disabled    ${ROOMOWNER_ADD_INPUT_OCCUPATION_OTHER_2_2_LOCATOR}
    #Salary (Baht)
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SALARY_2_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_SALARY_EN} 
    #Address
...
Verify screen page "Edit room owner" [Juristic person][Attach other documents]       
...
Verify screen page "Edit room owner" [Juristic person][Transfer detail]       
    ############## Transfer detail ############## 
    # Transfer detail
...
Verify screen page "Edit room owner" [Juristic person][Asset list]        
    ############## Asset list ############## 
    #Asset list
    ...
    Check For CheckRoomAsset Edit Owner    ${ROOMOWNER_ADD_LBD_ASSETLIST_LIST_LOCATOR}    nameEn    ${ROOMOWNER_EDIT_LBL_ASSETLIST_USAGESTATUS_RECEIVED_LOCATOR}    ${ROOMOWNER_EDIT_RDL_ASSETLIST_USAGESTATUS_RECEIVED_CHECK_LOCATOR}    ${DEFAULT_LBL_ASSETLIST_STATUS_RECEIVED_EN}    ${ROOMOWNER_EDIT_LBL_ASSETLIST_USAGESTATUS_NOTRECEIVED_LOCATOR}    ${ROOMOWNER_EDIT_RDL_ASSETLIST_USAGESTATUS_NOTRECEIVED_CHECK_LOCATOR}    ${DEFAULT_LBL_ASSETLIST_STATUS_NOTRECEIVED_EN}    ${ROOMOWNER_ADD_INPUT_ASSETLIST_REMARK_LOCATOR}    ${ROOMNO_B201}
...
Verify screen : Verify screen tab "Popup Profile"[Juristic person]
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMOWNER_EDIT_M13_0_1_3_002_SUCCESS_SCREENSHOT}
