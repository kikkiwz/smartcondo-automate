...
Verify screen : Verify list data in dropdown [Owner type][Individuals - Thai nationals]
    ...
    #Owner type *
    Element Text Should Be Value Dropdown    ${ROOMOWNER_ADD_DDL_TYPE_OWNERTYPE_2_1_LOCATOR}    ${ROOMOWNER_ADD_DDL_TYPE_OWNERTYPE_LIST_LOCATOR}    ${ROOMOWNER_ADD_DDL_TYPE_OWNERTYPE_CLASS_LOCATOR}    ${DEFAULT_LBL_TYPE_OWNERTYPE_EN}
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
