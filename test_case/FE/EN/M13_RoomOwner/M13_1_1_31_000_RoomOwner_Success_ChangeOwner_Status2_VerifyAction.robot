...
Verify Action : Click Save button input all data
    ...
    ChangeOwner RoomOwner input all field data Thai EN    ${ROOMNO_B201}
...
Verify Action : click Copy code button in code popup
    ...
    Generic Test Case Teardown RoomOwner Not Delete checkAsset No Close EN    ${ROOMOWNER_STAMPDELETE_FILENAME_VALUE}    ${PROPERTYE_ID_VALUE}    ${BUILDING_ID_VALUE}    ${ROOMNO_B201}
...
Verify Action : Click Save button input require field data
    ...
    ChangeOwner RoomOwner input require field data Thai EN    ${ROOMNO_B201}
