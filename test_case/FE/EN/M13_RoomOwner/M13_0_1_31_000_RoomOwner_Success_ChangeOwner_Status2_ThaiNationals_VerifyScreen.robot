...
*** Test Cases ***
################### Change owner ###################
M13_0_1_31_000_RoomOwner_Success_ChangeOwner_Status2_ChangeOwner_ThaiNationals_VerifyScreen [Verify screen page "Change owner"]
    ...
    ...    6. click ChangeOwner data button
...
Verify screen page "Change owner" [Individuals - Thai nationals] [Default page]

    ############## กรณีเลือก *ประเภทผู้ทำสัญญา เป็น "บุคคลธรรมดา - คนไทย" [1] ############## 

    #Read identification card
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_BTN_READIDENTIFICATIONCARD_1_LOCATOR}    ${ROOMOWNER_ADD_BTN_READIDENTIFICATIONCARD_EN} 
    #Note: The picture will be shown only when reading from the ID card only.
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_NOTE_IMAGE_THAINATIONS_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_NOTE_IMAGE_THAINATIONS_EN} 
    ...
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_EN} 
    ...
    #Occupation
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_OCCUPATION_2_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_OCCUPATION_EN} 
    #[กรอกอาชีพอื่นๆ]
    Wait Until Contains Element Should Be Disabled    ${ROOMOWNER_ADD_INPUT_OCCUPATION_OTHER_2_1_LOCATOR}
    #Salary (Baht)
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SALARY_2_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_SALARY_EN} 
    #Address
...
Verify screen page "Change owner" [Individuals - Thai nationals][Default page][Attach other documents]       
...
Verify screen page "Change owner" [Individuals - Thai nationals][Default page][Transfer detail]       
    ############## Transfer detail ############## 
    # Transfer detail
...
Verify screen page "Change owner" [Individuals - Thai nationals][Default page][Asset list]        
    ############## Asset list ############## 
    #Asset list
...
Verify screen : Verify list data in radiobutton [Room owner : ,Guest 1 :] [Individuals - Thai nationals]
    #Owner
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_OWNER_1_LOCATOR}    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_OWNER_EN} 
    Wait Should Contain Get Element Attribute    ${ROOMOWNER_CHANGEOWNER_RDL_TYPE_OWNER_1_CHECK_LOCATOR}    ${ATTRIBUTE_ARIACHECKED}    ${TRUE_LOWWER}
    #Guest
...
Verify screen : Verify screen tab "Popup Profile"[Individuals - Thai nationals]
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMOWNER_CHANGEOWNER_M13_0_1_31_000_SUCCESS_SCREENSHOT}
