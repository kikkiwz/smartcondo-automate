...
M13_0_1_2_002_RoomOwner_Success_Create_Status1_JuristicPerson_VerifyScreen [Verify screen page "Create room owner"]
...
Verify screen page "Create room owner" [Juristic person] 
    ...
    Wait Element Visible    ${ROOMOWNER_ADD_IMG_UPLOADAPICTUREOFALEGALENTITY_EXTERNAL_LOCATOR}
...
Verify screen page "Create room owner" [Juristic person][Attach other documents]       
...
Verify screen page "Create room owner" [Juristic person][Transfer detail]       
    ############## Transfer detail ############## 
    # Transfer detail
...
Verify screen page "Create room owner" [Juristic person][Asset list]        
    ############## Asset list ############## 
    #Asset list
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMOWNER_CREATE_M13_0_1_2_002_SUCCESS_SCREENSHOT}
