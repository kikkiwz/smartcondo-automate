...
Verify API onload and mapping data
    ...
    ${checkNodata}=    Run Keyword If    '${rowcountSearch}'=='0'    Wait Until Contains Element Text Should Be    ${MULCTCODE_SEARCH_LBL_RESULT_NODATA_LOCATOR}    ${DEFAULT_LBL_NODATA_EN}    #Nodata
    ...    ELSE IF    '${rowcountSearch}'!='0'    Check Value Table Search MulctCode    ${DEFAULT_EN}     ${rowcountSearch}    ${dataSearch}
...
Verify Action : click search button [Search Status]
    ...
    #Status
    Select Dropdown    ${MULCTCODE_SEARCH_DDL_STATUS_LOCATOR}    ${MULCTCODE_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${MULCTCODE_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${MULCTCODE_STATUS_EN_VALUE1}
    Sleep    0.5s
    #Click Search
    Click Element Page    ${MULCTCODE_SEARCH_BTN_SEARCH_LOCATOR}
...
Verify Action : click edit button
    ...
    #Edit Mulctcode
    Wait Until Contains Element Text Should Be    ${MULCTCODEEDIT_LBL_EDITMULCTCODE_LOCATOR}    ${MULCTCODEEDIT_LBL_EDITMULCTCODE_EN} 
...
Verify Action : click delete button
    ...
    Check Popup Delete Confirm EN    ${MULCTCODE_BTN_DELETE_LOCATOR}    ${MulctCode}
...
################### Generic Test Case Teardown ###################
    [Teardown]    Generic Test Case Teardown MulctCode2 EN    ${MULCTCODE_MULCTMETHOD_NAMETH_VALUE}    ${mulctMethodId}
