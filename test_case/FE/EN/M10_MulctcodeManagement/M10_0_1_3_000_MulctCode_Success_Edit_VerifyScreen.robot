...
M10_0_1_3_000_MulctCode_Success_Edit_VerifyScreen [Verify screen page "Edit Mulctcode"]
   ...
   [Setup]    Open Browser To Login Page Super Admin EN
    ...
    #Mulctcode NameTh *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_MULCTCODENAMETH_LOCATOR}    ${MULCTCODE_EDIT_LBL_MULCTCODENAMETH_EN} 
    ...
    #Mulctcode NameEn
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_MULCTCODENAMEEN_LOCATOR}    ${MULCTCODE_EDIT_LBL_MULCTCODENAMEEN_EN} 
    Wait Until Contains Element Should Be Enabled    ${MULCTCODE_EDIT_TXT_MULCTCODENAMEEN_LOCATOR}
    
    #Mulctcode *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_MULCTCODE_LOCATOR}    ${MULCTCODE_EDIT_LBL_MULCTCODE_EN} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_STATUS_LOCATOR}    ${MULCTCODE_EDIT_LBL_STATUS_EN} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_GROUPTYPE_LOCATOR}    ${MULCTCODE_VIEW_LBL_GROUPTYPE_EN} 
    ...
    #Mulct Method *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_MULCTMETHOD_LOCATOR}    ${MULCTCODE_EDIT_LBL_MULCTMETHOD_EN} 
    ...
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_VAT_LOCATOR}    ${MULCTCODE_EDIT_LBL_VAT_EN} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_TAX_LOCATOR}    ${MULCTCODE_EDIT_LBL_TAX_EN} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${MULCTCODE_EDIT_LBL_REMARK_LOCATOR}    ${MULCTCODE_EDIT_LBL_REMARK_EN} 
    Wait Until Contains Element Should Be Enabled    ${MULCTCODE_EDIT_TXTAREA_REMARK_LOCATOR}
    
    #Cancel button
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADDEDIT_BTN_CANCEL_LOCATOR}    ${MULCTCODE_ADDEDIT_BTN_CANCEL_EN} 
    #Save button
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADDEDIT_BTN_SAVE_LOCATOR}    ${MULCTCODE_ADDEDIT_BTN_SAVE_EN} 
...
Verify data list in Group Type dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTCODE_EDIT_DDL_GROUPTYPE_LOCATOR}    ${MULCTCODE_EDIT_DDL_GROUPTYPE_LIST_LOCATOR}    ${MULCTCODE_EDIT_DDL_GROUPTYPE_CLASS_LOCATOR}    ${valArrDataNameEn}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTCODE_EDIT_DDL_STATUS_LOCATOR}    ${MULCTCODE_EDIT_DDL_STATUS_LIST_LOCATOR}    ${MULCTCODE_EDIT_DDL_STATUS_CLASS_LOCATOR}    ${MULCTCODE_EDIT_DDL_STATUS_EN_VALUE}
    #close dropdrown
    Sleep    0.5s
