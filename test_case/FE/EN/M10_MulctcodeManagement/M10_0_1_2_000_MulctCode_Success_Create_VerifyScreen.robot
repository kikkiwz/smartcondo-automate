...
M10_0_1_2_000_MulctCode_Success_Create_VerifyScreen [Verify screen page "Create Mulctcode"]
    ...
    #Mulctcode NameTh *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_MULCTCODENAMETH_LOCATOR}    ${MULCTCODE_ADD_LBL_MULCTCODENAMETH_EN} 
    ...
    #Mulctcode NameEn
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_MULCTCODENAMEEN_LOCATOR}    ${MULCTCODE_ADD_LBL_MULCTCODENAMEEN_EN} 
    Wait Until Contains Element Should Be Enabled    ${MULCTCODE_ADD_TXT_MULCTCODENAMEEN_LOCATOR}
    
    #Mulctcode *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_MULCTCODE_LOCATOR}    ${MULCTCODE_ADD_LBL_MULCTCODE_EN} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_STATUS_LOCATOR}    ${MULCTCODE_ADD_LBL_STATUS_EN} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_GROUPTYPE_LOCATOR}    ${MULCTCODE_ADD_LBL_GROUPTYPE_EN} 
    ...
    #Mulct Method *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_MULCTMETHOD_LOCATOR}    ${MULCTCODE_ADD_LBL_MULCTMETHOD_EN} 
    ...
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_VAT_LOCATOR}    ${MULCTCODE_ADD_LBL_VAT_EN} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_TAX_LOCATOR}    ${MULCTCODE_ADD_LBL_TAX_EN} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${MULCTCODE_ADD_LBL_REMARK_LOCATOR}    ${MULCTCODE_ADD_LBL_REMARK_EN} 
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTCODE_ADD_DDL_STATUS_LOCATOR}    ${MULCTCODE_ADD_DDL_STATUS_LIST_LOCATOR}    ${MULCTCODE_ADD_DDL_STATUS_CLASS_LOCATOR}    ${MULCTCODE_ADD_DDL_STATUS_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
