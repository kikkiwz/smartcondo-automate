...
M12_0_1_2_000_MulctMethod_Success_Create_VerifyScreen [Verify screen page "Create Mulct Method"]
    ...
    #Mulct Method Name *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_MULCTMETHODNAME_LOCATOR}    ${MULCTMETHOD_ADD_LBL_MULCTMETHODNAME_EN} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_STATUS_LOCATOR}    ${MULCTMETHOD_ADD_LBL_STATUS_EN} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_REMARK_LOCATOR}    ${MULCTMETHOD_ADD_LBL_REMARK_EN} 
    ...
    #Adjustment Rate *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_ADJUSTMENTRATE_LOCATOR}    ${MULCTMETHOD_ADD_LBL_ADJUSTMENTRATE_EN} 
    ...
    #Unit Charge *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_LOCATOR}    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_EN} 
    Wait Should Contain Get Element Attribute    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    #Per the moment
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_PERTHEMOMENT_LOCATOR}    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_PERTHEMOMENT_EN} 
    #Per day
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_PERDAY_LOCATOR}    ${MULCTMETHOD_ADD_LBL_UNITCHARGE_PERDAY_EN} 
    
    #Calculation Method *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_LOCATOR}    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_EN} 
    Wait Should Contain Get Element Attribute    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    #Not roll over
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_NOPENALTYCHARGE_LOCATOR}    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_NOPENALTYCHARGE_EN} 
    #Roll over
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_CHARGEAFINE_LOCATOR}    ${MULCTMETHOD_ADD_LBL_CALCULATIONMETHOD_CHARGEAFINE_EN} 
    
    ############## Table [Header] ############## 
    #Time Unit
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_RESULT_TIMEUNIT_LOCATOR}    ${MULCTMETHOD_ADD_LBL_RESULT_TIMEUNIT_EN}
    #Number of time past the deadline
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_RESULT_NUMBEROFTIMEPASTTHEDEADLINE_LOCATOR}    ${MULCTMETHOD_ADD_LBL_RESULT_NUMBEROFTIMEPASTTHEDEADLINE_EN}
    
    #Amount
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_RESULT_AMOUNT_LOCATOR}    ${MULCTMETHOD_ADD_LBL_RESULT_AMOUNT_EN}    
    ...
    Sleep    0.5s
    #Percent
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_RESULT_PERCENT_LOCATOR}    ${MULCTMETHOD_ADD_LBL_RESULT_PERCENT_EN}
    ############## Table [Body] ############## 
    ...
    #Day/Month
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_DAYMONTH_LOCATOR}    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_DAY_EN}
    #Time Unit [เดือน]
    ...
    #Day/Month
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_DAYMONTH_LOCATOR}    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_MONTH_EN}
    ...
    #Onwards
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_RESULT_ONWARDS_LOCATOR}    ${MULCTMETHOD_ADD_LBL_RESULT_ONWARDS_EN}
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_ADD_DDL_STATUS_LOCATOR}    ${MULCTMETHOD_ADD_DDL_STATUS_LIST_LOCATOR}    ${MULCTMETHOD_ADD_DDL_STATUS_CLASS_LOCATOR}    ${MULCTMETHOD_ADD_DDL_STATUS_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Adjustment Rate dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_ADD_DDL_ADJUSTMENTRATE_LOCATOR}    ${MULCTMETHOD_ADD_DDL_ADJUSTMENTRATE_LIST_LOCATOR}    ${MULCTMETHOD_ADD_DDL_ADJUSTMENTRATE_CLASS_LOCATOR}    ${MULCTMETHOD_ADD_DDL_ADJUSTMENTRATE_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Time Unit dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_ADD_DDL_TIMEUNIT_LOCATOR}    ${MULCTMETHOD_ADD_DDL_TIMEUNIT_LIST_LOCATOR}    ${MULCTMETHOD_ADD_DDL_TIMEUNIT_CLASS_LOCATOR}    ${MULCTMETHOD_ADD_DDL_TIMEUNIT_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify screen : + Button  
    ...
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_DAYMONTH_LOCATOR}    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_MONTH_EN}
    #Day/Month
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_DAYMONTH2_LOCATOR}    ${MULCTMETHOD_ADD_LBL_TIMEUNIT_MONTH_EN}
