...
Verify API onload and mapping data
    ...
    ${checkNodata}=    Run Keyword If    '${rowcountSearch}'=='0'    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_NODATA_LOCATOR}    ${DEFAULT_LBL_NODATA_EN}    #Nodata
    ...    ELSE IF    '${rowcountSearch}'!='0'    Check Value Table Search IncomeCode    ${DEFAULT_EN}     ${rowcountSearch}    ${dataSearch}
...
Verify Action : click search button [Search Status]
    ...
    #Status
    Select Dropdown    ${INCOMECODE_SEARCH_DDL_STATUS_LOCATOR}    ${INCOMECODE_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${INCOMECODE_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${INCOMECODE_STATUS_EN_VALUE1}
    Sleep    0.5s
    #Click Search
    Click Element Page    ${INCOMECODE_SEARCH_BTN_SEARCH_LOCATOR}
...
Verify Action : click delete button
    ...
    Check Popup Delete EN    ${INCOMECODE_BTN_DELETE_LOCATOR}    ${IncomeCode}
...
################### Generic Test Case Teardown ###################
    [Teardown]    Generic Test Case Teardown IncomeCode2 EN    ${DATA_MULCTMETHOD_NAMETH_VALUE}    ${mulctCodeId}    ${mulctMethodId}
