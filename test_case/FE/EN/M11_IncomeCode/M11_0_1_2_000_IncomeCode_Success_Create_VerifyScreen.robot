...
M11_0_1_2_000_IncomeCode_Success_Create_VerifyScreen [Verify screen page "Create IncomeCode"]
    ...
    #IncomeCode NameTh *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_INCOMECODENAMETH_LOCATOR}    ${INCOMECODE_ADD_LBL_INCOMECODENAMETH_EN} 
    ...
    #IncomeCode NameEn
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_INCOMECODENAMEEN_LOCATOR}    ${INCOMECODE_ADD_LBL_INCOMECODENAMEEN_EN} 
    Wait Until Contains Element Should Be Enabled    ${INCOMECODE_ADD_TXT_INCOMECODENAMEEN_LOCATOR}
    
    #IncomeCode *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_INCOMECODE_LOCATOR}    ${INCOMECODE_ADD_LBL_INCOMECODE_EN} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_STATUS_LOCATOR}    ${INCOMECODE_ADD_LBL_STATUS_EN} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_GROUPTYPE_LOCATOR}    ${INCOMECODE_ADD_LBL_GROUPTYPE_EN} 
    ...
    #Price Per Unit *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_PRICEPERUNIT_LOCATOR}    ${INCOMECODE_ADD_LBL_PRICEPERUNIT_EN} 
    ...
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_CALCULATIONTYPE_LOCATOR}    ${INCOMECODE_ADD_LBL_CALCULATIONTYPE_EN} 
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_ADD_TXT_MULCTMETHOD_LOCATOR}
    
    #Calulation Method *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_ADD_LBL_CALCULATIONMETHOD_EN} 
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_ADD_TXT_MULCTMETHOD_LOCATOR}
    
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_VAT_LOCATOR}    ${INCOMECODE_ADD_LBL_VAT_EN} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_TAX_LOCATOR}    ${INCOMECODE_ADD_LBL_TAX_EN} 
    ...
    #Charge a mulct *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_LOCATOR}    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_EN} 
    #No penalty charge
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_NOPENALTYCHARGE_LOCATOR}    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_NOPENALTYCHARGE_EN} 
    #Charge a fine
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_CHARGEAFINE_LOCATOR}    ${INCOMECODE_ADD_LBL_CHAGEAMULCT_CHARGEAFINE_EN} 
    
    #Remark
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_REMARK_LOCATOR}    ${INCOMECODE_ADD_LBL_REMARK_EN} 
    ...
    #Mulctcode * 
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_MULCTCODE_LOCATOR}    ${INCOMECODE_ADD_LBL_MULCTCODE_EN} 
    Wait Should Contain Get Element Attribute    ${INCOMECODE_ADD_LBL_MULCTCODE_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_ADD_TXT_MULCTMETHOD_LOCATOR}
    
    #Calulation Method *
    Select Dropdown    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${INCOMECODE_CALCULATIONMETHOD_EN_VALUE2}
    Sleep    0.5s
    #Minimum Unit *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_MINIMUMUNIT_LOCATOR}    ${INCOMECODE_ADD_LBL_MINIMUMUNIT_EN} 
    ...
    #Calulation Method *
    Select Dropdown    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${INCOMECODE_CALCULATIONMETHOD_EN_VALUE3}
    Sleep    0.5s
    #Minimum Price *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_ADD_LBL_MINIMUMPRICE_LOCATOR}    ${INCOMECODE_ADD_LBL_MINIMUMPRICE_EN} 
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${INCOMECODE_ADD_DDL_STATUS_LOCATOR}    ${INCOMECODE_ADD_DDL_STATUS_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_STATUS_CLASS_LOCATOR}    ${INCOMECODE_ADD_DDL_STATUS_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Calculation type (every specified month) dropdown
    ...
    Element Text Should Be Value Dropdown Long    ${INCOMECODE_ADD_DDL_CALCULATIONTYPE_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONTYPE_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONTYPE_CLASS_LOCATOR}    ${DEFAULT_LBL_MONTH_EN}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
...
Verify data list in Calculation Method dropdown
    ...
    # Log To Console    [valArrDataNameTh] : ${valArrDataNameTh}
    # Log To Console    [valArrDataNameEn] : ${valArrDataNameEn}
    Element Text Should Be Value Dropdown    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${valArrDataNameEn}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
...
Verify data list in Mulctcode dropdown
    ...
    # Log To Console    [valArrDataNameTh] : ${valArrDataNameTh}
    # Log To Console    [valArrDataNameEn] : ${valArrDataNameEn}
    Element Text Should Be Value Dropdown    ${INCOMECODE_ADD_DDL_MULCTCODE_LOCATOR}    ${INCOMECODE_ADD_DDL_MULCTCODE_LIST_LOCATOR}    ${INCOMECODE_ADD_DDL_MULCTCODE_CLASS_LOCATOR}    ${valArrDataNameEn}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
