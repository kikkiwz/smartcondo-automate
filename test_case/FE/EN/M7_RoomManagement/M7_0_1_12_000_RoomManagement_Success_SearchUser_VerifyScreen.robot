...
Verify screen page Search Room details [User]
	...
	#ห้องทั้งหมด xx ห้อง
	${replaceTotalroom}=    Replace String    ${ROOMMANAGEMENT_SEARCH_LBL_TOTALROOM_EN}    [totalroom]    ${CountAllRoomGlobal}   
	...
	#Label: Status
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCH_LBL_STATUS_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_LBL_STATUS_EN}

	#Btn: Search
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCH_BTN_SEARCH_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_BTN_SEARCH_EN}
	Wait Until Contains Element Should Be Enabled    ${ROOMMANAGEMENT_SEARCH_BTN_SEARCH_LOCATOR}

	#Btn: clear
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCH_BTN_CLEAR_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_BTN_CLEAR_EN}
...
Verify hover in display : Transferred x room
	...
	${replaceTotalTranferRoom}=    Replace String    ${ROOMMANAGEMENT_SEARCH_LBL_TOTALROOMTANFER_EN}    [count]    ${CountTranferRoomGlobal}
...
Verify hover in display : Empty x room
	...
	${replaceTotalEmptyRoom}=    Replace String    ${ROOMMANAGEMENT_SEARCH_LBL_TOTALROOMEMPTY_EN}    [count]    ${CountEmptyRoomGlobal}
...
Verify list data in dropdown status
	...
	Element Text Should Be Value Dropdown    ${ROOMMANAGEMENT_SEARCH_DDL_STATUS_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${ROOMMANAGEMENT_SEARCH_DDL_STATUS_EN_VALUE}
	#close dropdrown
	Press Keys    ${NONE}    ${ESC}
	Sleep    0.5s
