...
M7_0_1_22_000_RoomManagement_Success_EditRoomIncomeAdmin_VerifyScreen [Verify screen]
	...
	Log To Console    ${\n}=========== Edit Room InCome Verify screen ===============
...
Verify screen page Edit Room - Income
...
Verify tooltip in button : Delete (Enable)
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMMANAGEMENT_EDITROOMADMIN_M7_0_1_22_000_SUCCESS_SCREENSHOT}
