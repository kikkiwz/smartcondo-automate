...
Verify screen page View Room-income User
    ...
    #Income code
    Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_VIEW_LBL_COLUM_INCOMECODE_LOCATOR}    ${ROOMMANAGEMENT_VIEW_LBL_COLUM_INCOMECODE_EN}
    Sleep    2s
    #Income name
    Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_VIEW_LBL_COLUM_INCOMENAME_LOCATOR}    ${ROOMMANAGEMENT_VIEW_LBL_COLUM_INCOMENAME_EN}
