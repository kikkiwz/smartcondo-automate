...
Verify API Onload and mapping data after click Bank Account Management
	...
	${checkNodata}=    Run Keyword If    '${rowcountGetIncomeDetail}'=='0'    Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_VIEW_LBL_RESULT_NODATA_LOCATOR}    ${DEFAULT_LBL_NODATA_EN}    #Nodata
    ...    ELSE IF    '${rowcountGetIncomeDetail}'!='0'    Check Value Table View Income Detail    ${DEFAULT_EN}     ${rowcountGetIncomeDetail}    ${dataSearchGetIncomeDetail}
