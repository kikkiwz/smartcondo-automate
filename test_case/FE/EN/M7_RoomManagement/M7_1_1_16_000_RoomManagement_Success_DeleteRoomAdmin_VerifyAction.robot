...
M7_1_1_16_000_RoomManagement_Success_DeleteRoomAdmin_VerifyAction [Verify Action ]
...
Verify action : click Cancel button
	...
	Check Popup Delete EN  ${roomNolocatorDelete}    ${ROOMMANAGEMENT_ADDEDITADMIN_VALUE_ROOMNO_LOCATOR}
...
Verify action : click Confirm button
	...
	#================ Verify DB ================	
	Request Verify DB Check Data Delete Room    ${MYSQL_TYPE_DELETE_ALLFIELD}    ${ROOMMANAGEMENT_ACCOUNTID_VALUE}         


	#capture page screenshot
    Selenium2Library.Capture Page Screenshot    ${ROOMMANAGEMENT_DELETEROOMADMIN_M7_1_1_16_000_SUCCESS_SCREENSHOT}
