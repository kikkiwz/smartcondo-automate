...
Verify Action : click save button or click Save and Continue button - input all field data 
	...
	Click Delete Data EN    ${roomNoDelete_locator}    ${ROOMMANAGEMENT_ADDEDITADMIN_VALUE2_ROOMNO_LOCATOR}
...
Verify Action : click save button or click Save and Continue button - input required field data 
	...
	Click Delete Data EN    ${roomNolocatorDelete}    ${ROOMMANAGEMENT_ADDEDITADMIN_VALUE2_ROOMNO_LOCATOR}
