...
Verify screen page "Search Room details [Admin]
	...
	#Label: Account
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_ACCOUNT_LOCATOR}    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_ACCOUNT_EN}
	# Wait Until Contains Element Should Be Enabled    ${ROOMMANAGEMENT_SEARCHADMIN_DDL_ACCOUNT_LOCATOR}


	#Label: Property
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_PROPERTY_LOCATOR}    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_PROPERTY_EN}
	Wait Until Contains Element Should Be Disabled    ${ROOMMANAGEMENT_SEARCHADMIN_DDL_PROPERTY_LOCATOR}


	#Label: Building
	Wait Until Contains Element Text Should Be    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_BUILDING_LOCATOR}    ${ROOMMANAGEMENT_SEARCHADMIN_LBL_BUILDING_EN}
	...
	${checkNodata}=    Run Keyword If    '${rowcountSearchRoomManagement}'!='0'    Check Value RoomList Admin EN    ${DEFAULT_EN}     ${rowcountSearchRoomManagement}    ${dataSearchRoomManagement}
