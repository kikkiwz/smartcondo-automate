...
Verify API onload and mapping data
    ...
    ${checkNodata}=    Run Keyword If    '${rowcountSearch}'=='0'    Wait Until Contains Element Text Should Be    ${EXPENSECODE_SEARCH_LBL_RESULT_NODATA_LOCATOR}    ${DEFAULT_LBL_NODATA_EN}    #Nodata
    ...    ELSE IF    '${rowcountSearch}'!='0'    Check Value Table Search ExpenseCode    ${DEFAULT_EN}     ${rowcountSearch}    ${dataSearch}
...
Verify Action : click search button [Search Status]
    ...
    #Status
    Select Dropdown    ${EXPENSECODE_SEARCH_DDL_STATUS_LOCATOR}    ${EXPENSECODE_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${EXPENSECODE_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${EXPENSECODE_STATUS_EN_VALUE1}
    Sleep    0.5s
    #Click Search
    Click Element Page    ${EXPENSECODE_SEARCH_BTN_SEARCH_LOCATOR}
...
Verify Action : click edit button
    ...
    #Edit Mulctcode
    Wait Until Contains Element Text Should Be    ${EXPENSECODEEDIT_LBL_EDITEXPENSECODE_LOCATOR}    ${EXPENSECODEEDIT_LBL_EDITEXPENSECODE_EN} 
...
################### Generic Test Case Teardown ###################
    [Teardown]    Generic Test Case Teardown ExpenseCode2 EN
