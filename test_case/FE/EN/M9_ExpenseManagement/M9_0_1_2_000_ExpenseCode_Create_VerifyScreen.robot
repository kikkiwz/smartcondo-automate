...
M9_0_1_2_000_ExpenseCode_Create_VerifyScreen [Verify screen page "Create Expense Code"]
    ...
    #Expensecode NameTh *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_EXPENSECODENAMETH_LOCATOR}    ${EXPENSECODE_ADD_LBL_EXPENSECODENAMETH_EN} 
    ...
    #Expensecode NameEn
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_EXPENSECODENAMEEN_LOCATOR}    ${EXPENSECODE_ADD_LBL_EXPENSECODENAMEEN_EN} 
    Wait Until Contains Element Should Be Enabled    ${EXPENSECODE_ADD_TXT_EXPENSECODENAMEEN_LOCATOR}
    
    #Expensecode *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_EXPENSECODE_LOCATOR}    ${EXPENSECODE_ADD_LBL_EXPENSECODE_EN} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_STATUS_LOCATOR}    ${EXPENSECODE_ADD_LBL_STATUS_EN} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_GROUPTYPE_LOCATOR}    ${EXPENSECODE_ADD_LBL_GROUPTYPE_EN} 
    ...
    #Price Per Unit *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_PRICEPERUNIT_LOCATOR}    ${EXPENSECODE_ADD_LBL_PRICEPERUNIT_EN} 
    ...
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_VAT_LOCATOR}    ${EXPENSECODE_ADD_LBL_VAT_EN} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_TAX_LOCATOR}    ${EXPENSECODE_ADD_LBL_TAX_EN} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_ADD_LBL_REMARK_LOCATOR}    ${EXPENSECODE_ADD_LBL_REMARK_EN} 
...
Verify data list in Group Type dropdown
    ...
    Element Text Should Be Value Dropdown    ${EXPENSECODE_ADD_DDL_GROUPTYPE_LOCATOR}    ${EXPENSECODE_ADD_DDL_GROUPTYPE_LIST_LOCATOR}    ${EXPENSECODE_ADD_DDL_GROUPTYPE_CLASS_LOCATOR}    ${valArrDataNameEn}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${EXPENSECODE_ADD_DDL_STATUS_LOCATOR}    ${EXPENSECODE_ADD_DDL_STATUS_LIST_LOCATOR}    ${EXPENSECODE_ADD_DDL_STATUS_CLASS_LOCATOR}    ${EXPENSECODE_ADD_DDL_STATUS_EN_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
