...
M16_0_1_5_000_Account_Success_View_VerifyScreen [Verify screen page "View Account"]
    ...
    #Account Name*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_ACCOUNTNAME_LOCATOR}    ${ACCOUNT_VIEW_LBL_ACCOUNTNAME_EN} 
	...
	#Name*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_NAME_LOCATOR}    ${ACCOUNT_VIEW_LBL_NAME_EN} 
    ...
    #Maximum Room*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_MAXIMUMROOM_LOCATOR}    ${ACCOUNT_VIEW_LBL_MAXIMUMROOM_EN} 
    ...
    #Phone*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_PHONE_LOCATOR}    ${ACCOUNT_VIEW_LBL_PHONE_EN} 
    ...
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_TAXPAYERIDENTIFICATIONNO_LOCATOR}    ${ACCOUNT_VIEW_LBL_TAXPAYERIDENTIFICATIONNO_EN} 
    ...
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_STARTDATE_LOCATOR}    ${ACCOUNT_VIEW_LBL_STARTDATE_EN} 
    ...
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_VIEW_LBL_EXPIREDATE_LOCATOR}    ${ACCOUNT_VIEW_LBL_EXPIREDATE_EN} 
    ...
    #Permanent 
    Wait Until Contains Element Text Should Be    ${ACCOUNT_VIEW_CHK_PERMANENT_LOCATOR}    ${ACCOUNT_VIEW_LBL_PERMANENT_EN} 

    #Permission
    Wait Until Contains Element Text Should Be    ${ACCOUNT_VIEW_LBL_PERMISSION_LOCATOR}    ${ACCOUNT_VIEW_LBL_PERMISSION_EN} 
    ...
    #Property
    Wait Until Contains Element Text Should Be    ${ACCOUNT_VIEW_LBL_PROPERTY_LOCATOR}    ${ACCOUNT_VIEW_LBL_PROPERTY_EN} 

    #No
    Wait Until Contains Element Text Should Be    ${ACCOUNT_VIEW_LBL_RESULT_NO_LOCATOR}    ${ACCOUNT_VIEW_LBL_RESULT_NO_EN} 
    #Property Name
    Wait Until Contains Element Text Should Be    ${ACCOUNT_VIEW_LBL_RESULT_PROPERTYNAME_LOCATOR}    ${ACCOUNT_VIEW_LBL_RESULT_PROPERTYNAME_EN} 
