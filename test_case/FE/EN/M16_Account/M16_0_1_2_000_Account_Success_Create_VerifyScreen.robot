...
M16_0_1_2_000_Account_Success_Create_VerifyScreen [Verify screen page "Create Account"]
    ...
    #Name*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_NAME_LOCATOR}    ${ACCOUNT_ADD_LBL_NAME_EN} 
    Wait Until Contains Element Should Be Visible    ${ACCOUNT_ADD_TXT_NAME_LOCATOR}
    
    #Maximum Room*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_MAXIMUMROOM_LOCATOR}    ${ACCOUNT_ADD_LBL_MAXIMUMROOM_EN} 
    Wait Until Contains Element Should Be Enabled    ${ACCOUNT_ADD_TXT_MAXIMUMROOM_LOCATOR}
    
    #Phone*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_PHONE_LOCATOR}    ${ACCOUNT_ADD_LBL_PHONE_EN} 
    Wait Until Contains Element Should Be Enabled    ${ACCOUNT_ADD_TXT_PHONE_LOCATOR}
    
    #Taxpayer Identification No*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_TAXPAYERIDENTIFICATIONNO_LOCATOR}    ${ACCOUNT_ADD_LBL_TAXPAYERIDENTIFICATIONNO_EN} 
    Wait Until Contains Element Should Be Visible    ${ACCOUNT_ADD_TXT_TAXPAYERIDENTIFICATIONNO_LOCATOR}
    
    #Start Date*
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_STARTDATE_LOCATOR}    ${ACCOUNT_ADD_LBL_STARTDATE_EN} 
    Wait Until Contains Element Should Be Visible    ${ACCOUNT_ADD_DATE_STARTDATE_INPUT_LOCATOR}
    
    #Expire Date 
    Wait Until Contains Get Text Split String Join    ${ACCOUNT_ADD_LBL_EXPIREDATE_LOCATOR}    ${ACCOUNT_ADD_LBL_EXPIREDATE_EN} 
    Wait Until Contains Element Should Be Visible    ${ACCOUNT_ADD_DATE_EXPIREDATE_INPUT_LOCATOR}
    
    #Permanent 
    Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_CHK_PERMANENT_LOCATOR}    ${ACCOUNT_ADD_LBL_PERMANENT_EN} 

    #Permission
    Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_PERMISSION_LOCATOR}    ${ACCOUNT_ADD_LBL_PERMISSION_EN} 
