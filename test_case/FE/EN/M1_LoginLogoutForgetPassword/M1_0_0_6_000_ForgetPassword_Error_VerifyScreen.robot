...
Verify wording required field (if don't input phone number)
	...
	Wait Until Contains Element Text Should Be    ${FORGETPASSWORD_LBL_FORGOTPASSWORDSMS_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PHONEISREQUIRED_EN} 
...
Verify wording required field (if input phone number is wrong)
	...
	Click Element Page    ${FORGETPASSWORD_TXT_FORGOTPASSWORDSMS_LOCATOR}	
	Wait Until Contains Element Text Should Be    ${FORGETPASSWORD_LBL_FORGOTPASSWORDSMS_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PHONEISNOTVALID_EN}  
