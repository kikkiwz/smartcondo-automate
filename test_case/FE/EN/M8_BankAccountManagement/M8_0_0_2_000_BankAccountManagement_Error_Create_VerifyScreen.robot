...
Verify wording required field [Bank]
	...
	Wait Until Contains Element Text Should Be    ${BANKACCOUNTINFORMATION_ADDEDIT_TXT_BANK_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PLEASESELECTDATA_EN} 
...
Verify wording required field [Bank Account Type]
	...
	Wait Until Contains Element Text Should Be    ${BANKACCOUNTINFORMATION_ADDEDIT_TXT_BANKACCOUNTTYPE_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PLEASESELECTDATA_EN} 
