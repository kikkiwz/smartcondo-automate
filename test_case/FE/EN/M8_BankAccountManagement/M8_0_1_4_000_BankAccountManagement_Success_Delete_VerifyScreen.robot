...
M8_0_1_4_000_BankAccountManagement_Success_Delete_VerifyScreen [Verify screen popup confirm delete ]
	...
	Check Popup Delete EN    ${BANKACCOUNTINFORMATION_BTN_DELETE_LOCATOR}    ${BANKACCOUNTINFORMATION_ACCOUNTNAME_VALUE2} - ${BANKACCOUNTINFORMATION_ACCOUNTPROMPTPAYNUMBER_VALUE2}
