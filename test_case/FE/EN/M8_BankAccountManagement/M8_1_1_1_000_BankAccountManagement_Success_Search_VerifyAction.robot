...
Verify Action : click search button [Search Status]
    ...
    #Status
	Select Dropdown    ${BANKACCOUNTINFORMATION_SEARCH_DDL_STATUS_LOCATOR}    ${BANKACCOUNTINFORMATION_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${BANKACCOUNTINFORMATION_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${BANKACCOUNTINFORMATION_STATUS_EN_VALUE1}
	Sleep    0.5s
	#Click Search
	Click Element Page    ${BANKACCOUNTINFORMATION_SEARCH_BTN_SEARCH_LOCATOR}
...
Verify Action : click delete button
	...
	Check Popup Delete EN    ${BANKACCOUNTINFORMATION_BTN_DELETE_LOCATOR}    ${BANKACCOUNTINFORMATION_ACCOUNTNAME_VALUE1} - ${BANKACCOUNTINFORMATION_ACCOUNTPROMPTPAYNUMBER_VALUE1}
