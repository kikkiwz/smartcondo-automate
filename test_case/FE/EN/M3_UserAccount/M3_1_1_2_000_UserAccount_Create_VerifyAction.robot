...
Verify API onload 
    ...
    Request Verify API On Load Create User Account API Search Prefix    EN
    Request Verify API On Load Create User Account API Search Property    EN
    #Click Cancel button
...
Verify Action : click save button [input all field data]
	...
	Check Value Table Search User    ${DEFAULT_EN}     ${rowcountSearchUserAccount}    ${dataSearchUserAccount}
...
Verify Action : click save button [input Require field data]
	...
	Check Value Table Search User Case Require Field    ${DEFAULT_EN}     ${rowcountSearchUserAccount}    ${dataSearchUserAccount}
