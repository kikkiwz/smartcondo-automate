...
M1_1_0_8_011_Login_Error_DataNotFound_NoDataTaxId [Data Not Found : Stamp Delete role]
    ...
    Update tb user_role set delete_at    ${LOGIN_STAMPDELETEUSERROLE_USERID_VALUE}    '${LOGIN_STAMPDELETEUSERROLE_PDPAFLAG_VALUE}'    ${LOGIN_STAMPDELETEUSERROLE_FILENAME_VALUE}
    ...
    #alert bottom
	Wait Until Contains Element Text Should Be    ${ALERT_BOTTOM_LBL_LOCATOR}    ${VALUE_RESULTDESCRIPTION_INTERNALSERVERERROR_TH}
