...
M1_0_0_8_000_Login_Error_VerifyScreen [Verify screen page Login]
	...
	Wait Until Contains Element Text Should Be    ${LOGIN_LBL_USERNAME_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 
	
	#password [Please input data]
	Click Element Page        ${LOGIN_TXT_PASSWORD_LOCATOR}
	Wait Until Contains Element Text Should Be    ${LOGIN_LBL_PASSWORD_PLEASEINPUTDATA_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 
