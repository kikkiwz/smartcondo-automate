...
Verify screen page "User Account"
    #Header
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_HEADER_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_HEADER_TH}
	Wait Until Contains Element Should Be Enabled    ${USERACCOUNT_SEARCH_LBL_HEADER_LOCATOR}

	#Label: Property Manager
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_PROPERTYMANAGER_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_PROPERTYMANAGER_TH}

	#Label: Firstname,Lastname,Email,Role
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_SEARCHFILTER_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_SEARCHFILTER_TH}

	#Label: Search
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_BTN_SEARCH_LOCATOR}    ${USERACCOUNT_BTN_SEARCH_TH}
	Wait Until Contains Element Should Be Enabled    ${USERACCOUNT_BTN_SEARCH_LOCATOR}

	#Label: clear
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_BTN_CLEAR_LOCATOR}    ${USERACCOUNT_BTN_CLEAR_TH}
	Wait Until Contains Element Should Be Enabled    ${USERACCOUNT_BTN_CLEAR_LOCATOR}

	Sleep    5s

    #LabelTable: No
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_RESULT_NO_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_RESULT_NO_TH}

    #LabelTable: First name - Last name
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_RESULT_NAME_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_RESULT_NAME_TH}

    #LabelTable: E-mail
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_RESULT_EMAIL_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_RESULT_EMAIL_TH}

	#LabelTable: License
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_SEARCH_LBL_RESULT_LICENSE_LOCATOR}    ${USERACCOUNT_SEARCH_LBL_RESULT_LICENSE_TH}


Verify screen : Verify defualt value dropdown list- Dropdown : Project Manager    
	Wait Until Contains Element Should Be Equal As Strings    ${USERACCOUNT_SEARCH_DDL_PROPERTYMANAGER_PLACEHOLDER_LOCATOR}    ${USERACCOUNT_SEARCH_TH_PROPERTYMANAGER_VALUE2} 

Verify placeholder- dropdown : select     
	Wait Should Contain Get Element Attribute    ${USERACCOUNT_SEARCH_DDL_PROPERTYMANAGER_LOCATOR}    ${ATTRIBUTE_PLACEHOLDER1_DX}    ${USERACCOUNT_SEARCH_TH_PROPERTYMANAGER_PLACEHOLDER_VALUE} 

Verify placeholder- dropdown : Firstname,Lastname,Email,Role     
	Wait Should Contain Get Element Attribute    ${USERACCOUNT_SEARCH_TXT_SEARCHFILTER_LOCATOR}    ${ATTRIBUTE_PLACEHOLDER1_DX}    ${USERACCOUNT_SEARCH_TH_SEARCHFILTER_PLACEHOLDER_VALUE} 
...
Verify tooltip in button 
	...
	Sleep    0.5s
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_LBL_EDIT_TH_LOCATOR}    ${USERACCOUNT_ICON_EDIT_TH}

	#Delete icon
	Wait Until Contains Element Should Be Visible    ${USERACCOUNT_ICON_DELETE_LOCATOR}
	Mouse Down    ${USERACCOUNT_ICON_DELETE_LOCATOR}
	Sleep    0.5s
	Wait Until Contains Element Text Should Be    ${USERACCOUNT_LBL_DELETE_TH_LOCATOR}    ${USERACCOUNT_ICON_DELETE_TH}
