...
Verify screen page Check asset management
	...
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_BTN_ADD_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_BTN_ADD_TH} 
	Wait Until Contains Element Should Be Enabled    ${ROLEMANAGEMENTINFORMATION_BTN_ADD_LOCATOR}


	#Label: Role Management
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_ROLEMANAGEMENT_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_ROLEMANAGEMENT_TH}

	#Label: Search
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_BTN_SEARCH_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_BTN_SEARCH_TH}
	Wait Until Contains Element Should Be Enabled    ${ROLEMANAGEMENTINFORMATION_BTN_SEARCH_LOCATOR}

	#Label: clear
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_BTN_CLEAR_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_BTN_CLEAR_TH}
	Wait Until Contains Element Should Be Enabled    ${ROLEMANAGEMENTINFORMATION_BTN_CLEAR_LOCATOR}

	Sleep    5s

    #LabelTable: No
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_RESULT_NO_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_RESULT_NO_TH}

	#LabelTable: Role Name
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_RESULT_ROLENAME_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_SEARCH_LBL_RESULT_ROLENAME_TH}
...
Verify tooltip in button 
	...
	Sleep    0.5s
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_LBL_VIEW_TH_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_ICON_VIEW_TH} 
	...
	Sleep    0.5s
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_LBL_EDIT_TH_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_ICON_EDIT_TH}
	...
	Sleep    0.5s
	Wait Until Contains Element Text Should Be    ${ROLEMANAGEMENTINFORMATION_LBL_DELETE_TH_LOCATOR}    ${ROLEMANAGEMENTINFORMATION_ICON_DELETE_TH} 
	Sleep    1s
...
Verify placeholder in Role Name
	Wait Should Contain Get Element Attribute    ${ROLEMANAGEMENTINFORMATION_SEARCH_PLACEHODER_ROLEMANAGEMENT_LOCATOR}    ${ATTRIBUTE_PLACEHOLDER_DX}    ค้นหา
