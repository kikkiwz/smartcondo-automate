...
Verify Action : click search button (Search status dropdown)
	...
	#Status
	Select Dropdown    ${ASSETMANAGEMENTINFORMATION_SEARCH_DDL_STATUS_LOCATOR}    ${ASSETMANAGEMENTINFORMATION_SEARCH_DDL_PROPERTYMANAGER_LIST_LOCATOR}    ${ASSETMANAGEMENTINFORMATION_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${ASSETMANAGEMENTINFORMATION_STATUS_TH_VALUE1}
	Sleep    0.5s
	#Click Search
...
Verify Action : click search button (Search status dropdown and Asset name textbox)
	...
	Wait Until Contains Input Text    ${ASSETMANAGEMENTINFORMATION_SEARCH_TXT_ASSETNAME_LOCATOR}    ${ASSETMANAGEMENTINFORMATION_ADDEDIT_ASSETNAMETH_VALUE}
	Sleep    0.5s
	#Click Search
	Click Element Page    ${ASSETMANAGEMENTINFORMATION_BTN_SEARCH_LOCATOR}
	...
	#====== Verify DB ==========
    #Inquiry for verify DB  
    ${resultSearchAssetManagement}=    Run keyword And Continue On Failure    Request Verify DB Check Data Search Check Asset Management    ${MYSQL_TYPE_CHECKASSETMANAGEMENT_SEARCH_ASSETNAMESTATUS}    ${ASSETMANAGEMENTINFORMATION_STATUSID_VALUE1}     ${ASSETMANAGEMENTINFORMATION_ADDEDIT_ASSETNAMETH_VALUE}    ${LIMIT_20}    ${OFFSET_0}    ${DB_TB_CHECKASSETMANAGEMENT_FIELD_STATUS} ${ORDERBY_DESC}
	Log To Console    resultSearchAssetManagement::${resultSearchAssetManagement}    
...
Verify Action : click Disable button
	...
	Click Disable TH  ${ASSETMANAGEMENTINFORMATION_ICON_DISABLE_LOCATOR}  ${ASSETMANAGEMENTINFORMATION_ADDEDIT_ASSETNAMETH_VALUE}
