...
M12_0_1_1_000_MulctMethod_Success_Search_VerifyScreen [Verify screen page "Search Mulct Method"]
    ...
    #Mulct Method Name
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_MULCTMETHODNAME_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_MULCTMETHODNAME_TH} 
    #Status
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_STATUS_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_STATUS_TH} 
    # Wait Should Contain Get Element Attribute    ${MULCTMETHOD_SEARCH_DDL_STATUS_PLACEHOLDER_LOCATOR}    ${ATTRIBUTE_PLACEHOLDER_DX}    ${DEFAULT_DDL_SELECT_TH} 
    # Element Text Should Be Value Dropdown    ${MULCTMETHOD_SEARCH_DDL_STATUS_LOCATOR}    ${MULCTMETHOD_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${MULCTMETHOD_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${MULCTMETHOD_SEARCH_DDL_STATUS_TH_VALUE}
    # #close dropdrown
    # Press Keys    ${NONE}    ${ESC}
    # Sleep    0.5s

    #Search button
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_BTN_SEARCH_LOCATOR}    ${MULCTMETHOD_SEARCH_BTN_SEARCH_TH} 
    Wait Until Contains Element Should Be Enabled    ${MULCTMETHOD_SEARCH_BTN_SEARCH_LOCATOR}
    #Clear button
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_BTN_CLEAR_LOCATOR}    ${MULCTMETHOD_SEARCH_BTN_CLEAR_TH} 
    Wait Until Contains Element Should Be Enabled    ${MULCTMETHOD_SEARCH_BTN_CLEAR_LOCATOR}

    #No
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_RESULT_NO_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_RESULT_NO_TH} 
    #Mulct Method Name
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_RESULT_MULCTMETHODNAME_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_RESULT_MULCTMETHODNAME_TH} 
    #Remark
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_RESULT_REMARK_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_RESULT_REMARK_TH} 
    #Status
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_SEARCH_LBL_RESULT_STATUS_LOCATOR}    ${MULCTMETHOD_SEARCH_LBL_RESULT_STATUS_TH} 
...
Verify tooltip in button - button : View - button : Edit - button : Delete 
    ...
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_LBL_VIEW_TH_LOCATOR}    ${MULCTMETHOD_LBL_VIEW_TH} 
    #edit icon
    Wait Until Contains Element Should Be Visible    ${MULCTMETHOD_BTN_EDIT_LOCATOR}
    Mouse Down    ${MULCTMETHOD_BTN_EDIT_LOCATOR}
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_LBL_EDIT_TH_LOCATOR}    ${MULCTMETHOD_LBL_EDIT_TH} 
    #delete icon
    Wait Until Contains Element Should Be Visible    ${MULCTMETHOD_BTN_DELETE_LOCATOR}
    Mouse Down    ${MULCTMETHOD_BTN_DELETE_LOCATOR}
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_LBL_DELETE_TH_LOCATOR}    ${MULCTMETHOD_LBL_DELETE_TH} 
