...
M12_0_1_3_000_MulctMethod_Success_Edit_VerifyScreen [Verify screen page "Edit Mulct Method"]
   ...
   [Setup]    Open Browser To Login Page Super Admin
    ...
    #Mulct Method Name *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_MULCTMETHODNAME_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_MULCTMETHODNAME_TH} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_STATUS_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_STATUS_TH} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_REMARK_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_REMARK_TH} 
    ...
    #Adjustment Rate *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_ADJUSTMENTRATE_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_ADJUSTMENTRATE_TH} 
    ...
    #Unit Charge *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_TH} 
    Wait Should Contain Get Element Attribute    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    #Per the moment
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_PERTHEMOMENT_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_PERTHEMOMENT_TH} 
    #Per day
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_PERDAY_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_UNITCHARGE_PERDAY_TH} 
    
    #Calculation Method *
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_TH} 
    Wait Should Contain Get Element Attribute    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    #Not roll over
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_NOPENALTYCHARGE_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_NOPENALTYCHARGE_TH} 
    #Roll over
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_CHARGEAFINE_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_CALCULATIONMETHOD_CHARGEAFINE_TH} 
    
    ############## Table [Header] ############## 
    #Time Unit
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_RESULT_TIMEUNIT_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_RESULT_TIMEUNIT_TH}
    #Number of time past the deadline
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_RESULT_NUMBEROFTIMEPASTTHEDEADLINE_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_RESULT_NUMBEROFTIMEPASTTHEDEADLINE_TH}
    
    #Amount
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_RESULT_AMOUNT_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_RESULT_AMOUNT_TH}    
    ...
    Sleep    0.5s
    #Percent
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_RESULT_PERCENT_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_RESULT_PERCENT_TH}
    ############## Table [Body] ############## 
    ...
    #Day/Month
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_TIMEUNIT_DAYMONTH_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_TIMEUNIT_DAY_TH}
    #Time Unit [เดือน]
    ...
    #Day/Month
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_TIMEUNIT_DAYMONTH_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_TIMEUNIT_MONTH_TH}
    ...
    #Onwards
    Wait Until Contains Element Text Should Be    ${MULCTMETHOD_EDIT_LBL_RESULT_ONWARDS_LOCATOR}    ${MULCTMETHOD_EDIT_LBL_RESULT_ONWARDS_TH}
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_EDIT_DDL_STATUS_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_STATUS_LIST_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_STATUS_CLASS_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_STATUS_TH_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Adjustment Rate dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_EDIT_DDL_ADJUSTMENTRATE_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_ADJUSTMENTRATE_LIST_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_ADJUSTMENTRATE_CLASS_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_ADJUSTMENTRATE_TH_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Time Unit dropdown
    ...
    Element Text Should Be Value Dropdown    ${MULCTMETHOD_EDIT_DDL_TIMEUNIT_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_TIMEUNIT_LIST_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_TIMEUNIT_CLASS_LOCATOR}    ${MULCTMETHOD_EDIT_DDL_TIMEUNIT_TH_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
