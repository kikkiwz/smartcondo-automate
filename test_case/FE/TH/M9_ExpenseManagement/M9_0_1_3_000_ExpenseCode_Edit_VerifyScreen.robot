...
M9_0_1_3_000_ExpenseCode_Edit_VerifyScreen [Verify screen page "Edit Expensecode"]
    ...
    #Expensecode NameTh *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_EXPENSECODENAMETH_LOCATOR}    ${EXPENSECODE_EDIT_LBL_EXPENSECODENAMETH_TH} 
    ...
    #Expensecode NameEn
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_EXPENSECODENAMEEN_LOCATOR}    ${EXPENSECODE_EDIT_LBL_EXPENSECODENAMEEN_TH} 
    Wait Until Contains Element Should Be Enabled    ${EXPENSECODE_EDIT_TXT_EXPENSECODENAMEEN_LOCATOR}
    
    #Expensecode *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_EXPENSECODE_LOCATOR}    ${EXPENSECODE_EDIT_LBL_EXPENSECODE_TH} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_STATUS_LOCATOR}    ${EXPENSECODE_EDIT_LBL_STATUS_TH} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_GROUPTYPE_LOCATOR}    ${EXPENSECODE_VIEW_LBL_GROUPTYPE_TH} 
    ...
    #Price Per Unit *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_PRICEPERUNIT_LOCATOR}    ${EXPENSECODE_EDIT_LBL_PRICEPERUNIT_TH} 
    ...
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_VAT_LOCATOR}    ${EXPENSECODE_EDIT_LBL_VAT_TH} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_TAX_LOCATOR}    ${EXPENSECODE_EDIT_LBL_TAX_TH} 
    ...
    #Remark
    Wait Until Contains Element Text Should Be    ${EXPENSECODE_EDIT_LBL_REMARK_LOCATOR}    ${EXPENSECODE_EDIT_LBL_REMARK_TH} 
...
Verify data list in Group Type dropdown
    ...
    Element Text Should Be Value Dropdown    ${EXPENSECODE_EDIT_DDL_GROUPTYPE_LOCATOR}    ${EXPENSECODE_EDIT_DDL_GROUPTYPE_LIST_LOCATOR}    ${EXPENSECODE_EDIT_DDL_GROUPTYPE_CLASS_LOCATOR}    ${valArrDataNameTh}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${EXPENSECODE_EDIT_DDL_STATUS_LOCATOR}    ${EXPENSECODE_EDIT_DDL_STATUS_LIST_LOCATOR}    ${EXPENSECODE_EDIT_DDL_STATUS_CLASS_LOCATOR}    ${EXPENSECODE_EDIT_DDL_STATUS_TH_VALUE}
    #close dropdrown
    Sleep    0.5s
