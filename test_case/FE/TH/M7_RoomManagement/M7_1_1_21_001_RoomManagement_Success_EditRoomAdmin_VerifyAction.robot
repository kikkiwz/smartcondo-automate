...
M7_1_1_21_001_RoomManagement_Success_EditRoomAdmin_VerifyAction [ Verify Action ]
...
Verify Action : click save button or click Save and Continue button - input all field data 
	...
	Sleep    4s
	Log To Console    roomNolocator: ${roomNolocator}  
	${roomNoDelete_locator}=    Replace String    ${ROOMMANAGEMENT_SEARCHADMIN_BTN_DELETEROOMNO_LOCATOR}    [room_no]    ${roomNo_edit}
	Set Global Variable    ${roomNolocatorDelete}    ${roomNoDelete_locator}
	Log To Console    roomNolocatorDelete ${roomNolocatorDelete}   
	Click Delete Data TH    ${roomNoDelete_locator}    ${ROOMMANAGEMENT_ADDEDITADMIN_VALUE2_ROOMNO_LOCATOR}
...
Verify Action : click save button or click Save and Continue button - input required field data 
	...
	Click Delete Data TH    ${roomNolocatorDelete}    ${ROOMMANAGEMENT_ADDEDITADMIN_VALUE2_ROOMNO_LOCATOR}


	#capture page screenshot
    Selenium2Library.Capture Page Screenshot    ${ROOMMANAGEMENT_EDITROOMADMIN_M7_1_1_21_001_SUCCESS_SCREENSHOT}
