...
M7_1_1_17_000_RoomManagement_Success_DeleteRoomInComeAdmin_VerifyAction [Verify screen]
...
Verify action : click Confirm button
	...
	Sleep    6s
	Click Delete Data TH    ${ROOMMANAGEMENT_ADDEDITADMIN_ICON_DELETE_LOCATOR}    ${ROOMMANAGEMENT_ADDEDITADMIN_INCOMECODE_VALUE}
	Sleep    3s
	#Click Close
	Click Element Page    ${ROOMMANAGEMENT_BTN_CLOSE_LOCATOR}
	#================ Verify DB ================	
	Request Verify DB Check Data Delete Income    ${MYSQL_TYPE_DELETE}
	Sleep    1s
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMMANAGEMENT_DELETEROOMADMIN_M7_1_1_17_000_SUCCESS_SCREENSHOT}
