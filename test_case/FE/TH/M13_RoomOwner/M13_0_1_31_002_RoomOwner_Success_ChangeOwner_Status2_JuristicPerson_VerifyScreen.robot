...
M13_0_1_31_002_RoomOwner_Success_ChangeOwner_Status2_JuristicPerson_VerifyScreen [Verify screen page "Change owner"]
    ...
    #Owner
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_OWNER_1_LOCATOR}    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_OWNER_TH} 
    ...
    #Guest Person
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_GUESTPERSON_1_LOCATOR}    ${ROOMOWNER_CHANGEOWNER_LBL_TYPE_GUESTPERSON_TH}
...
Verify screen page "Change owner" [Juristic person] 
    ...
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_UPLOADAPICTUREOFALEGALENTITY_LOCATOR}    ${ROOMOWNER_ADD_LBL_UPLOADAPICTUREOFALEGALENTITY_TH} 
    Wait Element Visible    ${ROOMOWNER_ADD_IMG_UPLOADAPICTUREOFALEGALENTITY_LOCATOR}
    
    #Company name *
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_COMPANYNAME_LOCATOR}    ${ROOMOWNER_ADD_LBL_COMPANYNAME_TH} 
    ...
    #Short name
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SHORTNAME_LOCATOR}    ${ROOMOWNER_ADD_LBL_SHORTNAME_TH} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_SHORTNAME_LOCATOR}
    #Juristic id
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_JURISTICID_LOCATOR}    ${ROOMOWNER_ADD_LBL_JURISTICID_TH} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_JURISTICID_LOCATOR}
    #Tax identification number
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_LOCATOR}    ${ROOMOWNER_ADD_LBL_TAXIDENTIFICATIONNUMBER_JURISTIC_TH} 
    ...
    #Fax
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_FAX_LOCATOR}    ${ROOMOWNER_ADD_LBL_FAX_TH} 
    ...
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_EDUCATION_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_EDUCATION_TH} 
    #Occupation
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_OCCUPATION_3_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_OCCUPATION_TH} 
    #[กรอกอาชีพอื่นๆ]
    Wait Until Contains Element Should Be Disabled    ${ROOMOWNER_ADD_INPUT_OCCUPATION_OTHER_3_2_LOCATOR}
    #Salary (Baht)
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SALARY_3_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_SALARY_TH} 
    #Address
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_ADDRESS_2_LOCATOR}    ${ROOMOWNER_ADD_LBL_ADDRESS_TH} 
    Wait Until Contains Element Should Be Enabled    ${ROOMOWNER_ADD_INPUT_ADDRESS_2_LOCATOR}
...
Verify screen page "Change owner" [Juristic person][Asset list]        
    ...
    Check For CheckRoomAsset Edit Owner    ${ROOMOWNER_ADD_LBD_ASSETLIST_LIST_LOCATOR}    nameTh    ${ROOMOWNER_CHANGEOWNER_LBL_ASSETLIST_USAGESTATUS_RECEIVED_LOCATOR}    ${ROOMOWNER_CHANGEOWNER_RDL_ASSETLIST_USAGESTATUS_RECEIVED_CHECK_LOCATOR}    ${DEFAULT_LBL_ASSETLIST_STATUS_RECEIVED_TH}    ${ROOMOWNER_CHANGEOWNER_LBL_ASSETLIST_USAGESTATUS_NOTRECEIVED_LOCATOR}    ${ROOMOWNER_CHANGEOWNER_RDL_ASSETLIST_USAGESTATUS_NOTRECEIVED_CHECK_LOCATOR}    ${DEFAULT_LBL_ASSETLIST_STATUS_NOTRECEIVED_TH}    ${ROOMOWNER_ADD_INPUT_ASSETLIST_REMARK_LOCATOR}    ${ROOMNO_B201}
