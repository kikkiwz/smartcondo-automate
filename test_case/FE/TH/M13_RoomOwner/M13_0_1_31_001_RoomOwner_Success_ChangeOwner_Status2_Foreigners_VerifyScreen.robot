...
M13_0_1_31_001_RoomOwner_Success_ChangeOwner_Status2_Foreigners_VerifyScreen [Verify screen page "Change owner"]
    ...
    Create RoomOwner input all field data Foreigners    ${ROOMNO_B201}
...
Verify screen page "Change owner" [Individuals - Foreigners] 
    ...
    #Occupation
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_OCCUPATION_3_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_OCCUPATION_TH} 
    #[กรอกอาชีพอื่นๆ]
    Wait Until Contains Element Should Be Disabled    ${ROOMOWNER_ADD_INPUT_OCCUPATION_OTHER_3_1_LOCATOR}
    #Salary (Baht)
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_ADD_LBL_SALARY_3_1_LOCATOR}    ${ROOMOWNER_ADD_LBL_SALARY_TH} 
    #Address
