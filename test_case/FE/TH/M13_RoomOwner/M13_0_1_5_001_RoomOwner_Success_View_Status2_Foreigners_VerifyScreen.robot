...
Verify screen page "View owner information" [Individuals - Foreigners]
    ...
    #Salary
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_VIEW_LBL_SALARY_31_LOCATOR}    ${ROOMOWNER_VIEW_LBL_SALARY_TH} 
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_VIEW_LBD_SALARY_31_LOCATOR}    ${ROOMOWNER_SALARY_BATH_50000_100000_TH_VALUE} 
    #Address
    Wait Until Contains Element Text Should Be    ${ROOMOWNER_VIEW_LBL_ADDRESS_3_LOCATOR}    ${ROOMOWNER_VIEW_LBL_ADDRESS_TH} 
