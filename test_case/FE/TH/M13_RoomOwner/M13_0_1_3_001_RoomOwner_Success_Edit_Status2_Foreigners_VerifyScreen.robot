...
*** Test Cases ***
################### [Edit] EditRoomOwner ###################
M13_0_1_3_001_RoomOwner_Success_Edit_Status2_Foreigners_VerifyScreen [Verify screen page "Edit room owner"]
...
Verify screen page "Edit room owner" [Individuals - Foreigners] 
...
Verify screen page "Edit room owner" [Individuals - Foreigners][Attach other documents]       
...
Verify screen page "Edit room owner" [Individuals - Foreigners][Transfer detail]       
    ############## Transfer detail ############## 
    # Transfer detail
...
Verify screen page "Edit room owner" [Individuals - Foreigners][Asset list]        
    ############## Asset list ############## 
    #Asset list
...
Verify screen : Verify screen tab "Popup Profile"[Foreigners]
    ...
    Selenium2Library.Capture Page Screenshot    ${ROOMOWNER_EDIT_M13_0_1_3_001_SUCCESS_SCREENSHOT}
