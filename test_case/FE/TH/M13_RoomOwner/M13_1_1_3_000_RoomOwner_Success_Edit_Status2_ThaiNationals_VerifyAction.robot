...
Verify Action : Click Save button change all data
    ...
    Edit RoomOwner input all field data Thai    ${ROOMNO_B201}
...
Verify Action : Click Save button change require field data
    ...
    # Click Room
    Click Room    ${ROOMNO_B201}
    Edit RoomOwner input require field data Thai    ${ROOMNO_B201}    
...
Verify Action : click save button if delete 2nd user onwards and add new user
    ...
    # Click Room
    Click Room    ${ROOMNO_B201}
    Edit RoomOwner input require field data add owner Thai    ${ROOMNO_B201}
...
Verify Action : click save button if delete 2nd user onwards 
    ...
    # Click Room
    Click Room    ${ROOMNO_B201}
    Create RoomOwner input require field data 2 Owner Thai    ${ROOMNO_B201}
    ...
    # Click Room
    Click Room    ${ROOMNO_B201}
    Edit RoomOwner input require field data delete owner Thai    ${ROOMNO_B201}
