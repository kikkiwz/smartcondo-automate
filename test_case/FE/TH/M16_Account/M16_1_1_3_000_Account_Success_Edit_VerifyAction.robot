...
Verify Action : click confirm Enable button
    ...
    Log To Console    nameProperty${nameProperty}
    #Click enable button        
    Click Enable and Disable and Check Text    ${ACCOUNT_EDIT_ICON_POPUPENABLE1_LOCATOR}    ${ALERT_TITLE_ENABLE_TH}    ${ALERT_CONTENT_ENABLE1_TH} ${nameProperty} ${ALERT_CONTENT_DELETE2_TH}    ${ALERT_BTN_CONFIRM_TH}    ${ALERT_BTN_CANCEL_TH}    ${VALUE_RESULTDESCRIPTION_SUCCESS_TH}
...
Verify Action : click edit button
    ...
    ${dataExcelColumn}=    Open Read Excel Column    ${EXCEL_PROPERTY_IMPORT_FILENAME_EDIT}     ${pathFile}    ${EXCEL_PROPERTY_IMPORT_COLNUM_1}    ${EXCEL_PROPERTY_IMPORT_MAXNUM_3}    ${EXCEL_PROPERTY_IMPORT_SHEETNAME}
    Log To Console    dataExcelColumn${dataExcelColumn}
