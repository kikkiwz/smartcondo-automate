...
Verify wording required field [Name]
	#Name *
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_NAME_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 

Verify wording required field [Maximum Room]
    #Maximum Room *
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_MAXIMUMROOM_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 

Verify wording required field [Phone]
    #Phone *
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_PHONE_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 

Verify wording required field [Taxpayer Identification No]
    #Taxpayer Identification No *
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_TAXPAYERIDENTIFICATIONNO_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 

Verify wording required field [Start Date]
    #Start Date *
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_DATE_STARTDATE_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 
...
Verify wording required field [Expire Date]
    ...
    #Expire Date
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_DATE_EXPIREDATE_VALID_LOCATOR}    ${VALID_LBL_PLEASEINPUTDATA_TH} 

Verify wording required field [Group Menu Name]
    Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_PERMISSION_MENU_VALID_LOCATOR}    ${VALID_LBL_PLEASESELECTDATA_TH} 
...
Verify wording invalid field [Phone]
	...
	Wait Until Contains Element Text Should Be    ${ACCOUNT_ADD_LBL_PHONE_FORMATVALID_LOCATOR}    ${VALID_LBL_PHONEISNOTVALID_TH} 
