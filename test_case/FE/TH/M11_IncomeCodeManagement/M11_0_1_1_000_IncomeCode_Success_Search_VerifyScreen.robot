...
M11_0_1_1_000_IncomeCode_Success_Search_VerifyScreen [Verify screen page "Search Income Code"]
    ...
    #Income Code
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_INCOMECODE_LOCATOR}    ${INCOMECODE_SEARCH_LBL_INCOMECODE_TH} 
    #Income Name
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_INCOMENAME_LOCATOR}    ${INCOMECODE_SEARCH_LBL_INCOMENAME_TH} 
    #Status
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_STATUS_LOCATOR}    ${INCOMECODE_SEARCH_LBL_STATUS_TH} 
    # Wait Should Contain Get Element Attribute    ${INCOMECODE_SEARCH_DDL_STATUS_PLACEHOLDER_LOCATOR}    ${ATTRIBUTE_PLACEHOLDER_DX}    ${DEFAULT_DDL_SELECT_TH} 
    # Element Text Should Be Value Dropdown    ${INCOMECODE_SEARCH_DDL_STATUS_LOCATOR}    ${INCOMECODE_SEARCH_DDL_STATUS_LIST_LOCATOR}    ${INCOMECODE_SEARCH_DDL_STATUS_CLASS_LOCATOR}    ${INCOMECODE_SEARCH_DDL_STATUS_TH_VALUE}
    # #close dropdrown
    # Press Keys    ${NONE}    ${ESC}
    # Sleep    0.5s
    #Payment order The system will pay the earnings encoded in a predetermined order.
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_NOTE_LOCATOR}    ${INCOMECODE_SEARCH_LBL_NOTE_TH} 

    #Search button
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_BTN_SEARCH_LOCATOR}    ${INCOMECODE_SEARCH_BTN_SEARCH_TH} 
    Wait Until Contains Element Should Be Enabled    ${INCOMECODE_SEARCH_BTN_SEARCH_LOCATOR}
    #Clear button
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_BTN_CLEAR_LOCATOR}    ${INCOMECODE_SEARCH_BTN_CLEAR_TH} 
    Wait Until Contains Element Should Be Enabled    ${INCOMECODE_SEARCH_BTN_CLEAR_LOCATOR}

    # #No
    # Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_NO_LOCATOR}    ${INCOMECODE_SEARCH_LBL_RESULT_NO_TH} 
    #Income code
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_INCOMECODE_LOCATOR}    ${INCOMECODE_SEARCH_LBL_RESULT_INCOMECODE_TH} 
    #Income Name
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_INCOMENAME_LOCATOR}    ${INCOMECODE_SEARCH_LBL_RESULT_INCOMENAME_TH} 
    #Payment Order
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_PAYMENTORDER_LOCATOR}    ${INCOMECODE_SEARCH_LBL_RESULT_PAYMENTORDER_TH} 
    #Status
    Wait Until Contains Element Text Should Be    ${INCOMECODE_SEARCH_LBL_RESULT_STATUS_LOCATOR}    ${INCOMECODE_SEARCH_LBL_RESULT_STATUS_TH} 
...
Verify tooltip in button - button : View - button : Edit - button : Delete 
    ...
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${INCOMECODE_LBL_VIEW_TH_LOCATOR}    ${INCOMECODE_LBL_VIEW_TH} 
    #edit icon
    Wait Until Contains Element Should Be Visible    ${INCOMECODE_BTN_EDIT_LOCATOR}
    Mouse Down    ${INCOMECODE_BTN_EDIT_LOCATOR}
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${INCOMECODE_LBL_EDIT_TH_LOCATOR}    ${INCOMECODE_LBL_EDIT_TH} 
    #delete icon
    Wait Until Contains Element Should Be Visible    ${INCOMECODE_BTN_DELETE_LOCATOR}
    Mouse Down    ${INCOMECODE_BTN_DELETE_LOCATOR}
    Sleep    0.5s
    Wait Until Contains Element Text Should Be    ${INCOMECODE_LBL_DELETE_TH_LOCATOR}    ${INCOMECODE_LBL_DELETE_TH} 
