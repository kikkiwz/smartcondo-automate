...
M11_0_1_3_000_IncomeCode_Success_Edit_VerifyScreen [Verify screen page "Edit Income Code"]
   ...
   [Setup]    Open Browser To Login Page Super Admin
    ...
    #Incomecode NameTh *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_INCOMECODENAMETH_LOCATOR}    ${INCOMECODE_EDIT_LBL_INCOMECODENAMETH_TH} 
    ...
    #Incomecode NameEn
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_INCOMECODENAMEEN_LOCATOR}    ${INCOMECODE_EDIT_LBL_INCOMECODENAMEEN_TH} 
    Wait Until Contains Element Should Be Enabled    ${INCOMECODE_EDIT_TXT_INCOMECODENAMEEN_LOCATOR}
    
    #Incomecode *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_INCOMECODE_LOCATOR}    ${INCOMECODE_EDIT_LBL_INCOMECODE_TH} 
    ...
    #Status *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_STATUS_LOCATOR}    ${INCOMECODE_EDIT_LBL_STATUS_TH} 
    ...
    #Group Type *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_GROUPTYPE_LOCATOR}    ${INCOMECODE_VIEW_LBL_GROUPTYPE_TH} 
    ...
    #Price Per Unit *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_PRICEPERUNIT_LOCATOR}    ${INCOMECODE_EDIT_LBL_PRICEPERUNIT_TH} 
    ...
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_CALCULATIONTYPE_LOCATOR}    ${INCOMECODE_EDIT_LBL_CALCULATIONTYPE_TH} 
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_EDIT_TXT_MULCTMETHOD_LOCATOR}
    
    #Payment Order *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_PAYMENTORDER_LOCATOR}    ${INCOMECODE_EDIT_LBL_PAYMENTORDER_TH} 
    ...
    #Calulation Method *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_EDIT_LBL_CALCULATIONMETHOD_TH} 
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_EDIT_TXT_MULCTMETHOD_LOCATOR}
    
    #Vat.(%) *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_VAT_LOCATOR}    ${INCOMECODE_EDIT_LBL_VAT_TH} 
    ...
    #Tax.(%) *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_TAX_LOCATOR}    ${INCOMECODE_EDIT_LBL_TAX_TH} 
    ...
    #Charge a mulct *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_LOCATOR}    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_TH} 
    #No penalty charge
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_NOPENALTYCHARGE_LOCATOR}    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_NOPENALTYCHARGE_TH} 
    #Charge a fine
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_CHARGEAFINE_LOCATOR}    ${INCOMECODE_EDIT_LBL_CHAGEAMULCT_CHARGEAFINE_TH} 
    
    #Remark
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_REMARK_LOCATOR}    ${INCOMECODE_EDIT_LBL_REMARK_TH} 
    ...
    #Mulctcode * 
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_MULCTCODE_LOCATOR}    ${INCOMECODE_EDIT_LBL_MULCTCODE_TH} 
    Wait Should Contain Get Element Attribute    ${INCOMECODE_EDIT_LBL_MULCTCODE_LOCATOR}    ${ATTRIBUTE_CLASS}    ${CLASS_REQUIRED}
    # Wait Until Contains Element Should Be Enabled    ${INCOMECODE_EDIT_TXT_MULCTMETHOD_LOCATOR}
    
    #Calulation Method *
    Select Dropdown    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${INCOMECODE_CALCULATIONMETHOD_TH_VALUE2}
    Sleep    0.5s
    #Minimum Unit *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_MINIMUMUNIT_LOCATOR}    ${INCOMECODE_EDIT_LBL_MINIMUMUNIT_TH} 
    ...
    #Calulation Method *
    Select Dropdown    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${INCOMECODE_CALCULATIONMETHOD_TH_VALUE3}
    Sleep    0.5s
    #Minimum Price *
    Wait Until Contains Element Text Should Be    ${INCOMECODE_EDIT_LBL_MINIMUMPRICE_LOCATOR}    ${INCOMECODE_EDIT_LBL_MINIMUMPRICE_TH} 
...
Verify data list in Group Type dropdown
    ...
    Element Text Should Be Value Dropdown    ${INCOMECODE_EDIT_DDL_GROUPTYPE_LOCATOR}    ${INCOMECODE_EDIT_DDL_GROUPTYPE_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_GROUPTYPE_CLASS_LOCATOR}    ${valArrDataNameTh}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
...
Verify data list in Status dropdown
    ...
    Element Text Should Be Value Dropdown    ${INCOMECODE_EDIT_DDL_STATUS_LOCATOR}    ${INCOMECODE_EDIT_DDL_STATUS_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_STATUS_CLASS_LOCATOR}    ${INCOMECODE_EDIT_DDL_STATUS_TH_VALUE}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    0.5s
...
Verify data list in Calculation type (every specified month) dropdown
    ...
    Element Text Should Be Value Dropdown Long    ${INCOMECODE_EDIT_DDL_CALCULATIONTYPE_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONTYPE_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONTYPE_CLASS_LOCATOR}    ${DEFAULT_LBL_MONTH_TH}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
...
Verify data list in Calculation Method dropdown
    ...
    # Log To Console    [valArrDataNameTh] : ${valArrDataNameTh}
    # Log To Console    [valArrDataNameEn] : ${valArrDataNameEn}
    Element Text Should Be Value Dropdown    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_CALCULATIONMETHOD_CLASS_LOCATOR}    ${valArrDataNameTh}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
...
Verify data list in Mulctcode dropdown
    ...
    # Log To Console    [valArrDataNameTh] : ${valArrDataNameTh}
    # Log To Console    [valArrDataNameEn] : ${valArrDataNameEn}
    Element Text Should Be Value Dropdown    ${INCOMECODE_EDIT_DDL_MULCTCODE_LOCATOR}    ${INCOMECODE_EDIT_DDL_MULCTCODE_LIST_LOCATOR}    ${INCOMECODE_EDIT_DDL_MULCTCODE_CLASS_LOCATOR}    ${valArrDataNameTh}
    #close dropdrown
    Press Keys    ${NONE}    ${ESC}
    Sleep    1s
